...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function transitionToGameView(isSoloParam) {
        ...
        if (isSoloParam) {
            ...
            if (mobilePlayersTab) mobilePlayersTab.parentElement.style.cssText = 'display: none !important;';
        } else { // Multiplayer
            ...
            if (mobilePlayersTab) mobilePlayersTab.parentElement.style.cssText = 'display: block !important;';
        }
        updateStats(0, 0, 0);
    }
