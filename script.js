...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const soloCompletionDiv = document.getElementById('solo-completion-message');
    const soloCompletionText = document.getElementById('soloCompletionText');
    ...
    if (playAgainSoloBtn) {
        playAgainSoloBtn.addEventListener('click', () => {
            gameOverModal.hide();
            transitionToRoomView();
        });
    }
    ...
    function showFinishedOverlay() {
        ...
        finishedText.textContent = message;
        finishedOverlay.classList.remove('d-none');
    }

    function hideFinishedOverlay() {
        if (finishedOverlay) {
            finishedOverlay.classList.add('d-none');
        }
    }
    ...
    function showLeaderboard(leaderboard, message) {
        ...
        soloCompletionDiv.style.display = 'none';
    ...
    function showSoloCompletionMessage() {
        const message = funnyMessages[Math.floor(Math.random() * funnyMessages.length)];
        document.getElementById('gameOverMessage').textContent = message;
        document.getElementById('leaderboard-podium').style.display = 'none';
        document.getElementById('leaderboard-rest').style.display = 'none';
        gameOverModal.show();
    }
