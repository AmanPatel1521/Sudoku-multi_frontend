...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function transitionToWaitingRoom() {
        ...
        console.log('After transitionToWaitingRoom - desktopChatToggleBtn classes:', desktopChatToggleBtn ? desktopChatToggleBtn.classList.value : 'N/A');
        console.log('After transitionToWaitingRoom - mobileChatToggleBtn classes:', mobileChatToggleBtn ? mobileChatToggleBtn.classList.value : 'N/A');
        updateStats(0, 0, 0);
    }
    ...
    function transitionToGameView(isSoloParam) {
        ...
        console.log('After transitionToGameView - desktopChatToggleBtn classes:', desktopChatToggleBtn ? desktopChatToggleBtn.classList.value : 'N/A');
        console.log('After transitionToGameView - mobileChatToggleBtn classes:', mobileChatToggleBtn ? mobileChatToggleBtn.classList.value : 'N/A');
    ...
    function transitionToRoomView() {
        ...
        console.log('After transitionToRoomView - desktopChatToggleBtn classes:', desktopChatToggleBtn ? desktopChatToggleBtn.classList.value : 'N/A');
        console.log('After transitionToRoomView - mobileChatToggleBtn classes:', mobileChatToggleBtn ? mobileChatToggleBtn.classList.value : 'N/A');
        stopTimer();
        resetGameState();
        playSoloBtn.disabled = false;
    }
