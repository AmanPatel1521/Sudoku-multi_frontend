...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const chatPaneWaiting = document.getElementById('chat-pane-waiting');
    ...
    function transitionToWaitingRoom() {
        ...
        if (chatPanel && chatPaneWaiting) {
            chatPaneWaiting.appendChild(chatPanel);
            chatPanel.style.display = 'block';
        }
        // Activate the Players tab by default
        const playersTabWaiting = document.getElementById('players-tab-waiting');
        if (playersTabWaiting) {
            new bootstrap.Tab(playersTabWaiting).show();
        }
        updateStats(0, 0, 0);
    }
