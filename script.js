...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const desktopChatSendBtn = document.getElementById('desktop-chat-send-btn');
    ...
    mobileChatSendBtn.addEventListener('click', sendMobileChatMessage);
    ...
    desktopChatSendBtn.addEventListener('click', sendDesktopChatMessage);
    ...
    function connectWebSocket() {
        ...
        socket.on('chat_message', (data) => {
            ...
            if(desktopChatMessages) {
                ...
                desktopChatMessages.appendChild(desktopMessageElement);
    ...
    function isChatFocused() {
        return document.activeElement === chatInput || document.activeElement === mobileChatInput || document.activeElement === desktopChatInput;
    }
    ...
    function transitionToGameView(isSoloParam) {
        ...
        desktopChatInput.disabled = false;
        desktopChatSendBtn.disabled = false;
        ...
        if (isSoloParam) {
            ...
            if(mobileChatToggleBtn) mobileChatToggleBtn.style.display = 'block';
            if(desktopChatToggleBtn) desktopChatToggleBtn.style.display = 'none'; // Hide desktop chat toggle in game view
