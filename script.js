...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const chatPanelOriginalParent = chatPanel.parentElement;
    const waitingRoomChatContainer = document.getElementById('waiting-room-chat-container');
    ...
    function transitionToWaitingRoom() {
        ...
        if (chatPanel && waitingRoomChatContainer) {
            waitingRoomChatContainer.appendChild(chatPanel);
