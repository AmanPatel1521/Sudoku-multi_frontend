...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const renderBoard = (puzzle, currentBoard, notesBoard) => {
        ...
        updateNumberPalette();
        // Re-apply number highlights after board render
        document.querySelectorAll('.cell').forEach(cell => {
            if (cell.textContent && !cell.classList.contains('has-notes')) {
                highlightActiveNumbers(parseInt(cell.textContent));
            }
        });
    };
    ...
    const selectCell = (cell) => {
        if (selectedCell) {
            ...
            clearHighlights(); // Clear highlights when a new cell is selected
        }
        selectedCell = cell;
    ...
    const clearHighlights = () => {
        document.querySelectorAll('.cell.highlight, .cell.wrong, .cell.selected').forEach(cell => {
            cell.classList.remove('highlight', 'wrong', 'selected');
        });
    };
