...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function showFinishedOverlay() {
        ...
        if (isSolo) {
            ...
            gameOverMessage.textContent = "You've conquered the puzzle! The leaderboard awaits, so hang tight for the grand reveal!";
        }
    ...
    function showEliminationOverlay(message) {
        ...
        gameOverMessage.textContent = `${message} Don't worry, champion, the leaderboard is still coming! Stick around to see the final scores.`;
