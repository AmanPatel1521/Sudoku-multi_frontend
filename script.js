        ...
        playerLists.forEach(playerListUl => {
            ...
            playersInRoom.forEach((player, index) => {
                ...
                if (!listItem) {
                    ...
                    const playerNameSpan = document.createElement('div'); // Changed to div
                    playerNameSpan.className = 'player-name';
                    playerInfo.appendChild(playerNameSpan);

                    const playerStatusSpan = document.createElement('div'); // Changed to div
                ...
                // Reset classes and text content before setting new ones
